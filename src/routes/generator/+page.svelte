...
<div class="m-4 grid grid-cols-2 justify-items-center p-4">
	<div class="left">
		<div class="h-[300px] w-[300px] p-4" style={cardStyle as string}>
			{#if blockName === ""}
				<h1
			...
			<p style="font-size: {Number(theme[9])}px;">
				...
				{#if dataSource == "" || dataSource == undefined}
					a data source
				{:else}
					<span style="padding:2px; font-weight: bold; background-color: {theme[8]};"
						>{dataSource}</span
					>
				{/if}
				about
				...
				{#if fuelType !== ""}
					for the <span style="padding:2px; font-weight: bold; background-color: {theme[8]};">
						{fuelType}
					</span>
				{/if}
			</p>
	...
	<div class="form-holder w-[45%] p-5">
		<form method="POST" id="gen-form">
			...
			<textarea
				...
				name="description"
				id="description"
				placeholder="Proved a brief description of the element"
				required
